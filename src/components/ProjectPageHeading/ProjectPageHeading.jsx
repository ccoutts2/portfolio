    ...
    <section className={styles.content}>
      ...
      <section className={styles.info_container}>
        ...
        <div className={styles.button_container}>
          <Link className={styles.link} href={gitHubLink} target="_blank">
            <Button label={`GitHub \u2198`} />
          </Link>
          {liveWebsite && (
            <Link className={styles.link} href={websiteLink} target="_blank">
              <Button label={`Live Website \u2198`} />
            </Link>
          )}
          {videoDemo && (
            <Link className={styles.link} href={videoLink} target="_blank">
